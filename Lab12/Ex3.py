...
print(f"\nTotal number of faculty members: {len(itm_faculty)}")
unique_faculty = set(itm_faculty) #set removes duplicates
print(f'Unique faculty members found: {len(unique_faculty)}')
